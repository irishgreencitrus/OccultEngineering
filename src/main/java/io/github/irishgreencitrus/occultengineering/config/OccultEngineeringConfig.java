...
public class OccultEngineeringConfig {
    ...
    private static OcEngConfigClient client;
    private static OcEngConfigServer server;

    public static OcEngConfigClient client() {
        return client;
    }

    public static OcEngConfigServer server() {
        return server;
    }
